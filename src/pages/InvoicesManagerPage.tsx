...
const InvoicesManagerPage = (): JSX.Element => {
    ...
    return (
        <Container>
            ...
            {invoicesList.length ? <InvoicesTable data={invoicesList} /> : <NoCompaniesMessage>No hay empresas disponibles.</NoCompaniesMessage>}
